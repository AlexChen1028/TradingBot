...
# BTC 關鍵區間（2026-08-20 更新）— 舊帶 68,000-71,000（STH平均成本線/200日均線，本輪熊市最後關鍵位）已於本日爆量突破：美國財政部宣布9月起國債回購規模翻倍（單次20億→40億，變相釋放流動性）為導火線，引爆21年熊市以來最大規模一次空頭爆倉，BTC觸及72,004；龐克明確表態「第一階段已完成」但仍需連續多日爆量才能確認熊市正式結束、單日突破尚不足夠
BTC_RESISTANCE_ZONE = (72_000, 75_000)  # 下一關鍵壓力帶（2026-08-20：龐克獨立標記72,000-74,000，現貨74,000掛有實際賣單佐證；飛揚獨立標記73,000-75,000週線費波位、稱「比較費勁」；兩者互相印證，飛揚並提及若突破則下看80,000）[COSMETIC/未接線]
