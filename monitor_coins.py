...
COIN_BLACKLIST        = {'CHZ', 'ORDI', 'WLD', 'LAB', 'ADA', 'HYPE', 'BCH'}  # CHZ: 2026-05-27 BTC歐陽; ORDI: 2026-06-01 BTC飛揚（廢了）; WLD: 2026-06-02 BTC飛揚（弱勢，禁做多）; LAB: 2026-06-04 BTC飛揚（24→15高位崩盤，勿碰）; ADA: 2026-06-04 BTC飛揚（跌破1.618失活，禁合約）; HYPE: 2026-06-06 BTC飛揚（跌破1.618，思路轉空，禁做多）; BCH: 2026-06-06 BTC飛揚（老牌山寨無操作價值）
...
# BTC 關鍵區間（三位 KOL 共識，2026-06-06 更新）
BTC_RESISTANCE_ZONE = (61_500, 62_000)  # 反彈高空帶（飛揚短線極限；歐陽波段更高 65K-66K）
BTC_SUPPORT_ZONE    = (59_000, 61_000)  # 追空禁令帶；生死線 59,800，失守→55K（6/06：60K 已跌破，插針 59,000）
...
def get_btc_kol_gate(exchange_pub):
    ...
    try:
        ...
        near_support  = bool(btc_px <= BTC_SUPPORT_ZONE[1] * 1.01)  # 2026-06-06 追空禁令：接近 59-61K（60K 已跌破，必有技術反彈）
