...
# BTC 關鍵區間（2026-07-15 更新）— CPI 大幅降溫（4.2→3.5）引爆暴拉 3,000 美金至 65,000-65,100，65,500 上邊緣僅差一步未破；三方接多帶一致上移 63,500-64,500（歐陽：64,000 化壓為撐、飛揚：64,000-64,500 低多、龐克：守住 64,000 短線仍強勢）
BTC_RESISTANCE_ZONE = (65_500, 67_000)  # 反彈壓力/高空帶（龐克 7/15：65,500＝區間上邊緣、突破站穩才看 69,138；歐陽 7/15：65,500 突破恐插針、67,000＝階段性頂部佈空位；飛揚 7/15：65,100 承壓回撤）[COSMETIC/未接線]
BTC_SUPPORT_ZONE    = (62_000, 64_000)  # 反彈支撐/回踩接多帶（歐陽 7/15：63,500-64,000 接多、64,000 化壓為撐；飛揚 7/15：64,000-64,500 低多；龐克 7/15：大鯨魚巨量買單上移 61,500、守 64,000 之上短線強勢）；near_support 連動 ≤64,640（BTC 回落接多區時禁山寨地板追空、防軋空/合山寨補漲）
BTC_HARD_STOP       = 69_150            # 站上 69,138 大級別關鍵位才轉空（週線 EMA 缺口；龐克 7/15：突破站穩 65,500 後即挑戰此位）
# ETH 關鍵區間（2026-07-16 更新）— 1,800 突破後最高 1,946 現 1,914；三方接多位齊上移至 1,850-1,900（歐陽 1,860-1,870／飛揚 1,900-1,902／龐克 1,850 站上續攻）；月線死亡三角未解除（飛揚三度重申）、2,000 下跌關口＝首目標（龐克）；歐陽：ETH 高點暫不明確、等 BTC 觸 67,000 後山寨再沖 1-2 天才定
ETH_RESISTANCE_ZONE = (1_900, 2_000)  # 高空帶（飛揚 7/14：突破後下一目標 1,900；歐陽 7/15：1,870-1,900 短期高點、空單倉位放小防插針；龐克 7/15：2,000＝下跌關口首目標、觸及先回踩）；未到此帶不追空
ETH_SUPPORT_ZONE    = (1_850, 1_900)  # 反彈支撐/低多帶（2026-07-16 三方接多位齊上移：歐陽 7/16 回落 1,860-1,870 接多、飛揚 7/15 晚間 1,900-1,902 接多、龐克 7/15 站上 1,850 續攻）；此區未跌破嚴禁追空（防軋空）；跌破 1,850 回看 1,800、跌破 1,800＝假突破翻回區間再議空
ETH_LONG_ZONE       = (1_850, 1_900)  # 回踩接多帶（2026-07-16 自 1,800-1,850 上移：歐陽 1,860-1,870 接多跟進飛揚 1,900-1,902＝觸發前日記錄的候選條件）；做多僅此區 ±1% 放行（≤1,919 不追漲），同區禁空
ETH_NO_LONG_ABOVE   = 1_900           # 1,900 以上不追多（高空帶起點；飛揚：別被反彈沖昏頭腦、月線未翻多）
...
def get_btc_kol_gate(exchange_pub):
    ...
    try:
        ...
        near_support  = bool(btc_px <= BTC_SUPPORT_ZONE[1] * 1.01)  # 山寨追空禁令：BTC 接近支撐區時（2026-07-15 ≤64,640＝63,500-64,500 回踩接多帶），BTC 易反彈帶動山寨補漲、防軋空
