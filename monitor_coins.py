...
COIN_BLACKLIST        = {'CHZ', 'ORDI', 'WLD', 'LAB', 'ADA'}  # CHZ: 2026-05-27 BTC歐陽; ORDI: 2026-06-01 BTC飛揚（廢了）; WLD: 2026-06-02 BTC飛揚（弱勢，禁做多）; LAB: 2026-06-04 BTC飛揚（24→15高位崩盤，勿碰）; ADA: 2026-06-04 BTC飛揚（跌破1.618失活，禁合約）
...
# BTC 關鍵區間（三位 KOL 共識，2026-06-04 更新）
BTC_RESISTANCE_ZONE = (67_000, 67_500)  # 反彈高空帶，逢此區間佈空（延續 6/03）
BTC_SUPPORT_ZONE    = (59_800, 61_000)  # 生死分水嶺，近此位追空禁令（6/04：BTC 直逼 60K，前低點/礦機成本區）
...
def get_btc_kol_gate(exchange_pub):
    ...
    try:
        ...
        near_support  = bool(btc_px <= BTC_SUPPORT_ZONE[1] * 1.01)  # 2026-06-04 追空禁令：接近 60-61K 生死分水嶺
