...
ETH_RESISTANCE_ZONE = (1_840, 1_860)  # 高空帶（飛揚 7/17 晚間：1,840-1,860 由支撐轉壓制、承壓可高空；龐克 7/17：1,850 收破後反抽不過繼續跌＝空單盈虧比好；上方 1,900/2,000 關口留 cosmetic 參考）；未到此帶不追空
ETH_SUPPORT_ZONE    = (1_800, 1_820)  # 短線強支撐帶（飛揚 7/17-7/18：1,800-1,820 很強支撐、1,800＝要命的分水嶺、未跌破行情非常難做嚴禁追空；4h 布林下軌托舉+TD9）；跌破 1,800＝追空啟動、飛揚下看 1,750、龐克下看 1,592/1,500
