...
# BTC 關鍵區間（2026-06-26 更新）— BTC 跌破 59-60K 二探、創熊市新低 58,000；6 萬不是底、別抄底，反彈高拋帶下移 60.5-62K
BTC_RESISTANCE_ZONE = (61_000, 62_000)  # 反彈高拋帶（歐陽 6/26：小反彈至 60,500-61,000 可 DC 高拋、62K 已是強壓力位）；嚴禁地板追空
...
# ETH 關鍵區間（2026-06-26 晚間飛揚更新）— ETH 隨 BTC 續跌至 1,500-1,600「純減錢」弱勢；operative 壓制下移 1,580-1,600、關鍵支撐 1,500-1,510（2618）
ETH_RESISTANCE_ZONE = (1_580, 1_600)  # 高空帶（飛揚 6/26：1,580-1,600 壓制、最好機會 1,600 整數關口、MA5 缺口 1,603）；1,580 以下為突破多頭區，未到此帶不追空
    ...
    for symbol in watch_coins:
        ...
        if result and result['n'] >= min_sig:
            ...
            if d == 1 and SHORT_BIAS and symbol in set(WATCH_ALWAYS) and result['n'] < min_sig + 1:
                ...
                continue
            # ETH 弱勢專屬閘門（2026-06-26 晚間飛揚：ETH 續跌 1,500-1,600，高空帶 1,580-1,600、關鍵支撐 1,500-1,510；1,520-1,580 突破多頭區禁追空；破 1,500 放行追空；做多仍僅 1,370-1,390）
