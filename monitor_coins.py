...
# BTC 關鍵區間（2026-07-06 更新）— 連漲 5-6 天自 57,700 觸 64,000，區間上移 60,000-65,500 震盪數週；三方共識到最強壓、涨不健康需回測（歐陽轉摩頂空/下半月主跌浪、飛揚月線高空防瀑布、龐克未創新高非反轉）
BTC_RESISTANCE_ZONE = (63_500, 65_500)  # 反彈壓力/高空帶（飛揚 7/6：目標 65,000-65,500＝886/上軌；歐陽 7/6：63,500-64,000 做空、大區間 65,000 強壓；龐克：需創 65,500 更高高點才終結下跌）[COSMETIC/未接線]
BTC_SUPPORT_ZONE    = (60_000, 62_000)  # 反彈支撐/回踩接多帶（歐陽 7/6：6 萬2 接多、大區間下沿；飛揚 7/5-7/6：62,000-63,500 錒低接多；龐克：61,097＝回踩最低限度、6 萬以下大鯨魚吸籌）；near_support 連動 ≤62,620（BTC 回落接多區時禁山寨地板追空、防軋空/合山寨補漲）
BTC_HARD_STOP       = 69_150            # 站上 69,138 大級別關鍵位才轉空（週線 EMA 缺口）
# ETH 關鍵區間（2026-07-06 更新）— ETH 觸 1,808 雙頂回落至 1,706；高空帶 1,780-1,800（1,800 分水嶺、突破 1,800-1,850 才下半場）、支撐/低多帶上移 1,700-1,720（飛揚 floor 由 1,640 抬至 1,700）；1,720-1,780 突破多頭區禁追空
ETH_RESISTANCE_ZONE = (1_780, 1_800)  # 高空帶（飛揚 7/5-7/6：1,800 成壓/分水嶺、突破 1,800-1,850 才下半場狂奔；歐陽 7/5：1,780 開空/1,800 頂）；未到此帶不追空
ETH_SUPPORT_ZONE    = (1_700, 1_720)  # 反彈支撐/低多帶（飛揚 7/5-7/6：1,704-1,720 景線區、站上 1,706 才確認低多、跌破 1,700-1,702 才追空）；此區未跌破嚴禁追空（防軋空）
...
def get_btc_kol_gate(exchange_pub):
    ...
    try:
        ...
        near_support  = bool(btc_px <= BTC_SUPPORT_ZONE[1] * 1.01)  # 山寨追空禁令：BTC 接近支撐區時（2026-07-06 ≤62,620＝6 萬2 回踩接多區），BTC 易反彈帶動山寨補漲、防軋空
