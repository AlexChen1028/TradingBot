...
BTC_SUPPORT_ZONE    = (64_000, 65_500)  # 反彈支撐/回踩接多帶（龐克 7/22：65,500 突破後回踩守住＝支撐確認、最低限度看 64,000；飛揚 7/22：65,500-66,000 低多支撐精準命中）；near_support 連動 ≤66,155（BTC 回落接多區時禁山寨地板追空、防軋空/合山寨補漲）
...
def get_btc_kol_gate(exchange_pub):
    ...
    try:
        ...
        near_support  = bool(btc_px <= BTC_SUPPORT_ZONE[1] * 1.01)  # 山寨追空禁令：BTC 接近支撐區時（2026-07-21 ≤66,155＝64,000-65,500 回踩接多帶），BTC 易反彈帶動山寨補漲、防軋空
