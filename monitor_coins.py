...
COIN_BLACKLIST        = {'CHZ', 'ORDI', 'WLD'}  # CHZ: 2026-05-27 BTC歐陽; ORDI: 2026-06-01 BTC飛揚（廢了）; WLD: 2026-06-02 BTC飛揚（弱勢，禁做多）
...
# BTC 關鍵區間（三位 KOL 共識，2026-06-03 更新）
...
def get_btc_kol_gate(exchange_pub):
    ...
    try:
        ...
        near_support  = bool(btc_px <= BTC_SUPPORT_ZONE[1] * 1.01)  # 2026-06-03 追空禁令：接近鯨魚護盤區
