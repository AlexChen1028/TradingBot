...
COIN_BLACKLIST        = {'CHZ', 'ORDI', 'WLD', 'LAB', 'ADA', 'HYPE', 'BCH', 'BEAT'}  # CHZ: 2026-05-27 BTC歐陽（6/07 復盤利好出盡 0.045→0.035 變廢紙）; ORDI: 2026-06-01 BTC飛揚（廢了）; WLD: 2026-06-02 BTC飛揚（弱勢，禁做多）; LAB: 2026-06-04 BTC飛揚（24→15高位崩盤，勿碰）; ADA: 2026-06-04 BTC飛揚（跌破1.618失活，禁合約）; HYPE: 2026-06-06 BTC飛揚（跌破1.618，思路轉空，禁做多）; BCH: 2026-06-06 BTC飛揚（老牌山寨無操作價值）; BEAT: 2026-06-09 BTC飛揚（0.12→2 主力控盤，空中樓閣隨時崩盤如LAB，嚴禁追高）
