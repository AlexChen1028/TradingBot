...
# BTC 關鍵區間（2026-07-21 更新）— ★BTC 明確突破並站穩 65,500（連續多根 4h K 收在 65,500 上、現 66,000-66,500 一帶），但飛揚/歐陽均未宣告結構翻多、龐克本人尚未表態確認創新高 → SHORT_BIAS 鬆動門檻未達成，僅上修接多/壓力帶★；接多帶上移 64,000-65,500（飛揚：64,500-65,000/64,000-64,500 低多；歐陽：中軌~64,000-65,000 接多、66,000-66,500 分批止盈）；cosmetic 壓力帶上移 66,000-67,000（歐陽：67,000＝反彈天花板，觸及即多轉空）
BTC_RESISTANCE_ZONE = (66_000, 67_000)  # 反彈壓力/高空帶（歐陽 7/21：66,000-66,500 分批止盈區、67,000＝整波反彈最終目標，觸及後多轉空；飛揚 7/21：MA55 兩度（7/15、7/20）壓制未破）[COSMETIC/未接線]
BTC_SUPPORT_ZONE    = (64_000, 65_500)  # 反彈支撐/回踩接多帶（飛揚 7/21：64,500-65,000/64,000-64,500 低多、4h 中軌托舉；歐陽 7/21：中軌區間~64,000-65,000 接多、昨日踏空者可於此補位）；near_support 連動 ≤66,155（BTC 回落接多區時禁山寨地板追空、防軋空/合山寨補漲）
BTC_HARD_STOP       = 69_150            # 站上 69,138 大級別關鍵位才轉空（週線 EMA 缺口；歐陽 7/21：67,000 為其反彈終點目標，非最終轉空位）
