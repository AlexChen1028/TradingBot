...
# ETH 關鍵區間（2026-07-15 更新）— CPI 利多引爆 1,800 大突破、最高 1,882 現 1,870；飛揚：日線收上 1,800＝多頭穩、月線需求看 1,900-2,000 但月線死亡三角未解除；龐克：MVRV 低估信號亮燈、站上 1,850 首目標 2,000；歐陽：1,780 多單獲利、1,870-1,900 短期高點摸頂空困難
...
ETH_SUPPORT_ZONE    = (1_800, 1_850)  # 反彈支撐/低多帶（飛揚 7/14-7/15：日線守住 1,800 多頭就穩、回踩 1,830-1,850 接多；龐克 7/15：站上 1,850 續攻）；此區未跌破嚴禁追空（防軋空）；跌破 1,800＝假突破翻回區間再議空
ETH_LONG_ZONE       = (1_800, 1_850)  # 回踩接多帶（2026-07-15 自悲觀二探 1,370-1,390 上移：飛揚 1,830-1,850 接多看 1,900、歐陽 1,780 多單+2,000U 續低多思路、龐克 MVRV 亮燈波段反彈可期）；做多僅此區 ±1% 放行（≤1,868 不追漲），同區禁空
