...
> Last updated: 2026-07-16 22:55 +08
...
- `near_support` gate: when BTC ≤ `BTC_SUPPORT_ZONE[1]`×1.01 (2026-07-15: 62K–64K，門檻 ≤64,640；CPI 暴拉後三方接多帶一致上移 63,500-64,500、歐陽 64,000 化壓為撐、防 BTC 回踩接多帶反彈帶動山寨補漲軋空), altcoin SHORT entries are skipped (追空禁令；跌破才有暴跌空間)
- ETH-only gate (`ETH_RESISTANCE_ZONE` 1,900–2,000 / `ETH_SUPPORT_ZONE` 1,850–1,900 / `ETH_LONG_ZONE` 1,850–1,900 / `ETH_NO_LONG_ABOVE` 1,900): 1,800 突破後最高 1,946→高空帶 1,900-2,000（飛揚目標 1,900/龐克 2,000 下跌關口首目標/歐陽 ETH 高點暫不明確等 BTC 67,000）、支撐/低多帶 7/16 再上移 1,850-1,900（三方接多位齊上移：歐陽 1,860-1,870／飛揚 1,900-1,902／龐克 1,850 站上續攻）。ETH LONG allowed **only** within the 回踩接多帶 (price ≤ ~1,919，不追漲), still requires SHORT_BIAS major +1 signal; ETH SHORT skipped while price is inside 支撐/接多帶 (1,831–1,919，防軋空)；shorts 放行 ≥1,919（高空帶）及破 <1,831 追空（跌破 1,850 回看 1,800、跌破 1,800＝假突破翻回區間）(2026-07-16 三方共識)
