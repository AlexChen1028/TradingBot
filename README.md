...
> Last updated: 2026-07-04 22:26 +08
...
- `near_support` gate: when BTC ≤ `BTC_SUPPORT_ZONE[1]`×1.01 (2026-07-03: 58.5K–60K，門檻 ≤60,600；6 萬關口轉有效支撐、59.5-60K 回踩接多區、防 BTC 反彈帶動山寨軋空), altcoin SHORT entries are skipped (追空禁令；跌破才有暴跌空間)
- ETH-only gate (`ETH_RESISTANCE_ZONE` 1,780–1,800 / `ETH_SUPPORT_ZONE` 1,600–1,640 / `ETH_LONG_ZONE` 1,370–1,390 / `ETH_NO_LONG_ABOVE` 1,700): ETH 自 1,500 反彈站上 1,715（匯率隊領漲）→高空帶上移 1,780-1,800（歐陽 7/3：1,780 開空/1,800 頂）、支撐/回踩接多帶上移 1,600-1,640（歐陽 1,620 支組復換/1,600-1,610 接多、飛揚 1,675 缺口）。ETH LONG allowed **only** within the 悲觀二探 zone (price ≤ ~1,404), blocked elsewhere (大結構偏空不追多); ETH SHORT skipped while price is inside 悲觀二探 (1,356–1,404)、支撐帶 (1,600–1,640)、**或突破多頭區 (1,640–1,780，未到高空帶不追空防軋空)**；shorts 放行 ≥1,780（接 1,780-1,800 高空帶）及破 <1,600 追空 (2026-07-03 歐陽/飛揚)
