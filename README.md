...
> Last updated: 2026-07-15 23:50 +08
...
- ETH-only gate (`ETH_RESISTANCE_ZONE` 1,900–2,000 / `ETH_SUPPORT_ZONE` 1,800–1,850 / `ETH_LONG_ZONE` 1,800–1,850 / `ETH_NO_LONG_ABOVE` 1,900): CPI 利多引爆 1,800 大突破觸 1,882→高空帶上移 1,900-2,000（飛揚目標 1,900/歐陽 1,870-1,900 短期高點空單放小/龐克 2,000 下跌關口首目標）、支撐/低多帶上移 1,800-1,850（飛揚日線守 1,800＝多頭穩、回踩 1,830-1,850 接多；龐克 1,850 站上續攻）。**ETH LONG 解禁**：allowed **only** within the 回踩接多帶 (price ≤ ~1,868，不追漲；自 7/6 悲觀二探 1,370-1,390 上移), still requires SHORT_BIAS major +1 signal; ETH SHORT skipped while price is inside 支撐/接多帶 (1,782–1,868)、**或突破多頭區 (1,850–1,900，未到高空帶不追空防軋空)**；shorts 放行 ≥1,900（高空帶）及破 <1,782 追空（跌破 1,800＝假突破翻回區間）(2026-07-15 三方共識)
