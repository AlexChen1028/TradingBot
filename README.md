...
> Last updated: 2026-07-12 18:06 +08
...
- `near_support` gate: when BTC ≤ `BTC_SUPPORT_ZONE[1]`×1.01 (2026-07-06: 60K–62K，門檻 ≤62,620；BTC 觸 64K 後區間上移 60-65.5K、6 萬2 為回踩接多區、防 BTC 反彈帶動山寨補漲軋空), altcoin SHORT entries are skipped (追空禁令；跌破才有暴跌空間)
- ETH-only gate (`ETH_RESISTANCE_ZONE` 1,780–1,800 / `ETH_SUPPORT_ZONE` 1,700–1,720 / `ETH_LONG_ZONE` 1,370–1,390 / `ETH_NO_LONG_ABOVE` 1,700): ETH 觸 1,808 雙頂回落 1,706→高空帶 1,780-1,800（飛揚 1,800 分水嶺/突破 1,800-1,850 才下半場）、支撐/低多帶上移 1,700-1,720（飛揚 floor 由 1,640 抬至 1,700、站上 1,706 才確認低多）。ETH LONG allowed **only** within the 悲觀二探 zone (price ≤ ~1,404), blocked elsewhere (大結構偏空不追多); ETH SHORT skipped while price is inside 悲觀二探 (1,356–1,404)、支撐帶 (1,700–1,720)、**或突破多頭區 (1,720–1,780，未到高空帶不追空防軋空)**；shorts 放行 ≥1,780（接 1,780-1,800 高空帶）及破 <1,700 追空（飛揚：跌破 1,700-1,702 才追空）(2026-07-06 飛揚/歐陽)
