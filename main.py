...
# KEY_RESISTANCE_ZONE : 64,000~65,500（64-65K 反彈高空帶；上方硬壓 66-67K 通道頂/布林上軌；硬止損 69,138）
# KEY_SUPPORT_ZONE    : 61,000~62,000（62,000 兩度測試守住＝反彈起點/追空分界；61K≈200週均線深支撐）
# 注意：BTC 62,200 反彈至 64K 但反彈無量、高點下移；嚴禁 62K 地板追空（軋空＋二探風險）；大級別仍偏空
KEY_SUPPORT_ZONE    = (61_000, 62_000)   # 2026-06-21 62K 兩度守住反彈起點；61K=200週均線深支撐
KEY_RESISTANCE_ZONE = (64_000, 65_500)   # 2026-06-21 反彈高空帶（64-65K 開空；硬壓 66-67K）
