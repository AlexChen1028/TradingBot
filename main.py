...
# KEY_RESISTANCE_ZONE : 64,000~65,500（跌破 65,500 後反彈高空帶：64,000 上週雙底頸線、65,500 破位轉壓；硬止損 69,138）
# KEY_SUPPORT_ZONE    : 60,000~61,100（200 週均線≈61,097 熊市最後撿錢區 + 60K 大級別支撐；假跌破 61,000 收回→強反彈）
# 注意：BTC 三天 67K→62K；資費低位+太多人做空=軋空風險，嚴禁地板追空；微策略暴雷判定為噪音；大級別仍偏空
KEY_SUPPORT_ZONE    = (60_000, 61_100)   # 2026-06-19 200週均線撿錢區，假跌破收回→強反彈
KEY_RESISTANCE_ZONE = (64_000, 65_500)   # 2026-06-19 反彈高空帶（雙底頸線64K/破位線65.5K）
