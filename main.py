...
# KEY_RESISTANCE_ZONE : 60,500~61,500（反彈高拋帶；飛揚 6/28 死亡三角 60.5-60.6K、MA5 61K；歐陽 6/28 611-615 開空）
# KEY_SUPPORT_ZONE    : 58,000~59,000（58K 二探止跌後短暫支撐/別地板空；歐陽 6/28 58,003 低點）
# 注意：BTC 6/28 58K 二探止跌、6 萬弱勢無量震盪；空頭主導未變、6 萬=多空生死線，別抄底、別地板空（軋空風險）
KEY_SUPPORT_ZONE    = (58_000, 59_000)   # 2026-06-28 二探止跌後短暫支撐；別地板空、短期沒支撐
KEY_RESISTANCE_ZONE = (60_500, 61_500)   # 2026-06-28 反彈高拋帶（飛揚死亡三角 60.5K、歐陽 611-615）
