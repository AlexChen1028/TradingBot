...
# KEY_RESISTANCE_ZONE : 63,000~64,000（超跌反彈帶；歐陽 63K=4h 下軌复换才再跌；飛揚 61-61.5K 高空、64K MA5 缺口）
# KEY_SUPPORT_ZONE    : 59,000~60,000（二探/最後支撐；歐陽 6/25 放量跌 59K 企穩、60K 关口不能破、別地板空）
# 注意：BTC 6/25 破 62K 暴跌至 59K 二探企穩、現 ~61K；多頭已清算、60K 為最後做多機會但大級別仍偏空
KEY_SUPPORT_ZONE    = (59_000, 60_000)   # 2026-06-25 二探/最後支撐；60K 关口不能破、別地板空
KEY_RESISTANCE_ZONE = (63_000, 64_000)   # 2026-06-25 超跌反彈帶（63K 复换再跌；64K MA5 缺口/前壓）
