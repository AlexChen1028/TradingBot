...
# KEY_RESISTANCE_ZONE : 66,000~67,500（67,200 高空命中後軋空續演：保守 66,000-66,500 歐陽佈空；積極 67,000-67,500 軋空終極目標；硬止損 69,150）
# KEY_SUPPORT_ZONE    : 65,200~65,500（關鍵防守線；回踩不破可反手短多；守 65,500 則續向上爆破）
# 注意：極端負費率+OI 創新高=主力惡意軋空起手式；清算空頭非反轉，大級別仍偏空；嚴禁地板追空
KEY_SUPPORT_ZONE    = (65_200, 65_500)   # 2026-06-16 關鍵防守線，回踩不破可反手短多
KEY_RESISTANCE_ZONE = (66_000, 67_500)   # 2026-06-16 軋空強壓（保守66-66.5K/積極67-67.5K，硬止損69,150）
