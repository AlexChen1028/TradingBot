...
# KEY_RESISTANCE_ZONE : 61,000~62,000（反彈高拋帶；歐陽 6/26 小反彈 60.5-61K DC 高拋、62K 已是強壓力位）
# KEY_SUPPORT_ZONE    : 58,000~59,000（破位後短暫支撐/別地板空；歐陽 6/26 跌破二探創熊市新低 58K）
# 注意：BTC 6/26 跌破 59-60K 二探、創熊市新低 58,000；6 萬不是底、別抄底，別地板空（軋空風險），下看前跌區間
KEY_SUPPORT_ZONE    = (58_000, 59_000)   # 2026-06-26 破位後短暫支撐；別地板空、短期沒支撐
KEY_RESISTANCE_ZONE = (61_000, 62_000)   # 2026-06-26 反彈高拋帶（60.5-61K DC 高拋；62K 強壓力）
